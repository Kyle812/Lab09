...
public class MusicStore {
    ...
    public MusicStore() {
        maxProducts = 10;
        Product[] storeProducts = new Product[maxProducts];
	...
	Product[] filteredProducts = new Product[this.totalProducts];
        ...
        if (audio) {
            for (int i = 0; i < totalProducts; i++){
                if (storeProducts[i] instanceof AudioProduct) {
                    filteredProducts[count] = storeProducts[i];
                    count++;
                }
            }
        } else {
            for (int i = 0; i < totalProducts; i++){
                if (storeProducts[i] instanceof VideoProduct) {
                    filteredProducts[count] = storeProducts[i];
                    count++;
                }
            }
